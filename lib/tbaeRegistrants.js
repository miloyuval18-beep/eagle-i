...
// The TBAE download endpoint's profession_type_id for each roster —
// confirmed live: 3 = Architects, 2 = Registered Interior Designers,
// 1 = Landscape Architects. Same file shape for all three.
...
async function runFullImport({ dryRun = false, log = () => {} } = {}) {
  ...
  const professions = [
    ...
    { key: 'landscape_architect', label: 'Landscape Architects' }
  ];
  const counts = {};
