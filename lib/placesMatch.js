...
//  - the listing's address is in the record's city (or zip, when we have one).
function isLikelySameBusiness({ recordName, recordCity, recordZip, matchedName, matchedAddress }) {
