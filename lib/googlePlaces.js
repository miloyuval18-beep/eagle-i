...
const PLACE_FIELD_MASK = 'places.id,places.displayName,places.rating,places.userRatingCount,places.formattedAddress,places.websiteUri,nextPageToken';
...
module.exports = { searchNearbyCompetitors, geocodeAddress, getPlaceRatingById };
