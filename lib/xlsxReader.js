...
// readZipEntries is also exported for reuse: any file that's a plain ZIP
// archive (not just .xlsx) can use it to pull out named entries without a
// third-party unzip dependency — see scripts/importHcadZipValues.js, which
// uses it to pull real_acct.txt out of HCAD's much larger Real_acct_owner.zip.
module.exports = { readXlsxFirstSheet, readZipEntries };
