#!/usr/bin/env node
// Manual, on-demand run of the same full FDIC bank import
// lib/fdicBanksWorker.js runs automatically once a month. See
// lib/fdicBanks.js's runFullImport.
//
// Usage:
//   node scripts/importFdicBanks.js               # fetches, imports, writes to DB
//   node scripts/importFdicBanks.js --dry-run      # fetches + parses, prints summary, writes nothing
...
async function main() {
  ...
  const { runFullImport } = require('../lib/fdicBanks');
