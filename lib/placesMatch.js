...
const GENERIC_TOKENS = new Set([
  ...
  'houston', 'texas', 'tx',
  // Words that name the profession rather than the business — "Kamma Design
  // Group" and "Canaima Design" share nothing that identifies either one.
  'design', 'designs', 'designers', 'studio', 'studios', 'architecture', 'architects', 'architect', 'architectural',
  'interiors', 'interior', 'landscape', 'landscapes', 'engineering', 'engineers', 'engineer', 'surveying', 'surveyors',
  'planning', 'partners', 'partner', 'consulting', 'consultants', 'development', 'properties', 'realty', 'real', 'estate',
  'title', 'escrow', 'brokerage', 'brokers', 'firm', 'office', 'international', 'intl', 'america', 'american', 'usa',
  'bank', 'banks', 'national', 'association', 'trust', 'savings', 'federal', 'credit', 'union', 'na', 'lender', 'lending', 'mortgage', 'supply', 'supplies', 'rental', 'rentals', 'equipment', 'lawn', 'lumber', 'materials'
]);
