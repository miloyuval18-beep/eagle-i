...
// Rows -> array of objects keyed by the first row's header names. Header
// names are trimmed (TDA's real export uses ", " — a space after every
// comma — which would otherwise leave every key but the first with a
// leading space, e.g. " ACCOUNT_TYPE"); data values are left exactly as
// found, since a value's own whitespace could occasionally be meaningful.
